        ...
        <Dialog.Portal>
            <div className="contact-modal">
                ...
                <div className="contact-modal__field-group">
                    <label className="contact-modal__label" htmlFor="contact-email">Email</label>
                    <input
                        ref={emailRef}
                        id="contact-email"
                        name="email"
                ...
                <div className="contact-modal__field-group">
                    <label className="contact-modal__label" htmlFor="contact-subject">Sujet</label>
                    <select
                        ref={subjectRef}
                        id="contact-subject"
                        name="subject"
                ...
                <div className="contact-modal__field-group">
                    <label className="contact-modal__label" htmlFor="contact-message">Message</label>
                    <textarea
                        ref={messageRef}
                        id="contact-message"
                        name="message"
