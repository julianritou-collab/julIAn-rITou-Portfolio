...
function About() {
  ...
  return <TypeWriter text="En 2001, un développeur fut condamné à résoudre des bugs que personne ne voulait toucher. Aujourd’hui, recherché par les startups pour ses compétences improbables, il survit en acceptant les missions que les autres considèrent comme impossibles:
